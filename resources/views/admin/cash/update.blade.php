                            ...
                            <div class="col-lg-6">
                                <div class="dashboard_breadcam text-end">
                                    <p>
                                        ...
                                        <i class="fas fa-caret-right"></i> Edit Cash Entry
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="white_card card_height_100 mb_30">
                        <div class="white_card_body">
                            <div class="card-body">
                                ...
                                <form action="{{ route('cash.update', $edit->id) }}" method="post">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6 mt-3">
                                            ...
                                            <select name="type" id="type" class="form-control @error('type') is-invalid @enderror" required>
                                                <option value="cash_payment" {{ old('type', $edit->type) === 'cash_payment' ? 'selected' : '' }}>Cash Payment</option>
                                                <option value="cash_receive" {{ old('type', $edit->type) === 'cash_receive' ? 'selected' : '' }}>Cash Receive</option>
                                            </select>
                                            @error('type')
                                        ...
                                        <div class="col-md-6 mt-3">
                                            ...
                                            <input name="cash_date" type="date"
                                                   ...
                                                   id="cash_date"
                                                   value="{{ old('cash_date', optional($edit->cash_date)->format('Y-m-d')) }}" required>
                                            @error('cash_date')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
