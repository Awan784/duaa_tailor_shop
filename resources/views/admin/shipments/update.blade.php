                            ...
                            <div class="col-lg-6">
                                <div class="dashboard_breadcam text-end">
                                    <p>
                                        ...
                                        <i class="fas fa-caret-right"></i> Edit Shipment
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="white_card card_height_100 mb_30">
                        <div class="white_card_body">
                            <div class="card-body">
                                ...
                                <form action="{{ route('shipments.update', $edit->id) }}" method="post" id="shipmentForm">
                                    @csrf
                                    @method('PUT')
                                    <div class="row mb-3">
                                            ...
                                            <select name="customer_id" id="customer_id"
                                                ...
                                                @foreach ($customers as $customer)
                                                    <option value="{{ $customer->id }}"
                                                        {{ (string) old('customer_id', $edit->customer_id) === (string) $customer->id ? 'selected' : '' }}>
                                                        {{ $customer->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-4 mt-3">
                                            ...
                                            <input name="shipment_date" type="date"
                                                   ...
                                                   id="shipment_date"
                                                   value="{{ old('shipment_date', $edit->shipment_date ? $edit->shipment_date->format('Y-m-d') : date('Y-m-d')) }}"
                                                   required>
                                            @error('shipment_date')
                                        ...
                                        <div class="col-md-4 mt-3">
                                            ...
                                            <input name="shipment_number" type="text"
                                                   ...
                                                   id="shipment_number"
                                                   value="{{ old('shipment_number', $edit->shipment_number) }}"
                                        ...
                                        <div class="col-md-4 mt-3">
                                            ...
                                            <input name="charges" type="number" step="0.01" min="0"
                                                   ...
                                                   id="charges"
                                                   value="{{ old('charges', $edit->charges) }}"
                                                   placeholder="0.00">
                                            @error('charges')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="col-md-12 mt-3">
                                            ...
                                            <textarea name="description" id="description" rows="3"
                                                      ...
                                                      placeholder="Optional notes...">{{ old('description', $edit->description) }}</textarea>
                                            @error('description')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
...
@section('js')
    ...
    <script>
        (function () {
            ...
            const shipmentId = @json($edit->id);
            const oldSaleIds = @json(array_map('intval', (array) old('sale_ids', $selectedSaleIds)));
            ...
            function loadInvoices(preserveSelected) {
                ...
                $.get(invoicesUrl + '/' + customerId, { status: status, shipment_id: shipmentId })
                    .done(function (res) {
